...
void GameStage_6::Initialize()
{
	...
	Mapchip::CsvToVector(map, "Resources/csv/stage6.csv");//mapNum=0
	...
	XMFLOAT3 pos_range2 = { b_posX - 10.0f, -65.0f, 0.0f };

	XMFLOAT3 pos_range3 = { b_posX + 10.0f, -65.0f, 0.0f };
	XMFLOAT3 pos_range4 = { b_posX + 45.0f, -65.0f, 0.0f };

	XMFLOAT3 pos_range5 = { b_posX, -40.0f, 0.0f };
	XMFLOAT3 pos_range6 = { b_posX, -10.0f, 0.0f };

	// バレルの向き
	XMFLOAT3 rot1 = { 0.0f ,180.0f ,0.0f };
	XMFLOAT3 rot2 = { 0.0f ,180.0f ,0.0f };
	XMFLOAT3 rot3 = { 0.0f ,180.0f ,-90.0f };
	XMFLOAT3 rot4 = { 0.0f ,180.0f ,180.0f };

	XMFLOAT3 rot5 = { 0.0f ,180.0f ,0.0f };

	// バレル初期化
	barrel1 = Barrel::Initialize(XMFLOAT3(b_posX - 10.0f, -65.0f, 0.0f), pos_range1, pos_range2, rot1, 70.0f);
	barrel2 = Barrel::Initialize(XMFLOAT3(b_posX + 10.0f, -65.0f, 0.0f), pos_range3, pos_range4, rot2, 70.0f);
	barrel3 = Barrel::Initialize(XMFLOAT3(b_posX		, -65.0f, 0.0f), zero, zero, rot3, 40.0f);
	barrel4 = Barrel::Initialize(XMFLOAT3(b_posX		, -10.0f, 0.0f), pos_range5, pos_range6, rot4, 70.0f);
...
void GameStage_6::MapCreate(int mapNumber)
{
...
bool GameStage_6::MapCollide(XMFLOAT3& pos, float radiusX, float radiusY, int mapNumber, const XMFLOAT3 oldPos)
{
	//マップチップ
	//X, Y
	float mapX = 0;
