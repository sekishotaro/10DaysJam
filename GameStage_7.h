...
class GameStage_7 : public BaseScene
{
private: // エイリアス
	// Microsoft::WRL::を省略
...
public:
	...
	// バレル
	std::vector<int> rotation1;
	std::vector<int> rotation2;
	...
	std::unique_ptr<Object3d> barrelObject6;
	std::unique_ptr<Object3d> barrelObject7;
	Model* BarrelModel;
