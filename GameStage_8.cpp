...
void GameStage_8::Initialize()
{
	...
	Mapchip::CsvToVector(map, "Resources/csv/stage8.csv");//mapNum=0
	...
	// バレル移動範囲
	XMFLOAT3 pos_range1 = { b_posX - 65.0f, -65.0f, 0.0f };
	XMFLOAT3 pos_range2 = { b_posX + 65.0f, -65.0f, 0.0f };
...
void GameStage_8::MapCreate(int mapNumber)
{
...
bool GameStage_8::MapCollide(XMFLOAT3& pos, float radiusX, float radiusY, int mapNumber, const XMFLOAT3 oldPos)
{
	//マップチップ
	//X, Y
	float mapX = 0;
